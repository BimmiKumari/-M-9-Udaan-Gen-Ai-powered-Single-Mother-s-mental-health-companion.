...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between rounded-md border-[1px] border-[#00FFFF]  p-8 px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-[#00FFFF] p-8 px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-[#00FFFF] p-8 px-12">
        ...
        <div className="flex max-w-[500px] justify-between">
          <div className="flex flex-col gap-y-5">
            <div>
              <p className="mb-2 text-sm border-[#00FFFF]">First Name</p>
